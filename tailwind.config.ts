...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "cyber-gradient": "linear-gradient(135deg, hsl(var(--background)) 0%, hsl(var(--card)) 100%)",
        "accent-gradient": "linear-gradient(135deg, hsl(var(--primary) / 0.2) 0%, transparent 100%)",
      },
    },
  },
